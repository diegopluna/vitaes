...
export const kendallRoyResume: Resume = {
  ...
  work: [
    ...
    },
    {
      ...
      highlights: [
        {
          id: 'hl-vaulter-1-9s0t',
          value:
            'Transformed struggling digital media company into a profitable business.',
        },
        {
          id: 'hl-vaulter-2-1u2v',
          value: 'Negotiated strategic partnerships and acquisitions.',
        },
        {
          id: 'hl-vaulter-3-3w4x',
          value:
  ...
  education: [
    ...
    },
    {
      ...
      description: [
        ...
        { id: 'edu-brown-desc-2-m3n4', value: 'Member of the Economics Club.' },
      ],
    },
  ],
  extracurriculars: [],
