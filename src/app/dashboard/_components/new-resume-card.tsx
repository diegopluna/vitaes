...
export const NewResumeCard = () => {
  ...
  return (
    <Card
      ...
      className="bg-muted/60 dark:bg-card flex flex-col h-full overflow-hidden group hover:cursor-pointer dark:hover:shadow-muted hover:shadow-lg transition-all duration-300 ease-in-out"
    >
      <CardHeader className="p-0 gap-0">
        <div className="h-full overflow-hidden">
          <div className="w-full aspect-[1/1.414] bg-white flex items-center justify-center object-cover group-hover:bg-primary/10 transition-colors duration-300 ease-in-out">
            <FilePlus className="w-12 h-12 text-black group-hover:text-primary group-hover:scale-110 transition-all duration-300 ease-in-out" />
          </div>
        </div>
