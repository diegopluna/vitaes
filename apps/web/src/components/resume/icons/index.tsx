...
// Mobile Icon
export const MobileIcon = ({ size = 10, color = '#000000' }: IconProps) => (
...
export const EmailIcon = ({ size = 10, color = '#000000' }: IconProps) => (
...
export const HomepageIcon = ({ size = 10, color = '#000000' }: IconProps) => (
...
export const GitHubIcon = ({ size = 10, color = '#000000' }: IconProps) => (
...
export const LinkedInIcon = ({ size = 10, color = '#000000' }: IconProps) => (
...
export const TwitterIcon = ({ size = 10, color = '#000000' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 512 512">
    <Path
