...
export function WritingForm() {
  ...
  const onDragEnd = (result) => {
    ...
    const items = Array.from(writings.writings);
          ...
          {writings.enabled && (
            <div className="space-y-1">
              ...
              <DragDropContext onDragEnd={onDragEnd}>
                <Droppable droppableId="writings">
                  {(provided) => (
                    <div
                                ...
                                <AccordionTrigger>
                                  <div className="items-center justify-center">
                                    <Button
                                      ...
                                      variant={"ghost"}
                                      onClick={() => {
                                        const newWritings = writings.writings.slice();
                                      ...
                                      (description, descriptionIndex) => (
                                        ...
                                        >
                                          <Button
                                            ...
                                            onClick={() => {
                                              const newWritings = writings.writings.slice();
                                              newWritings[index].descriptions.splice(
                                                descriptionIndex,
                                                1
                                              );
                                              setWritings(newWritings);
