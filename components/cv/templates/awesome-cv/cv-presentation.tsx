                ...
                {props.presentations.map((presentation, index) => (
                    <div className="w-full" key={index}>
                        <div className="flex justify-between w-full">
                            ...
                            <span className="text-xs italic text-[#0395de]">{presentation.location}</span>
                        </div>
                        <div className="flex justify-between w-full">
                            <span className="text-xs text-gray-600">{presentation.role.toUpperCase()}</span>
                            <span className="text-xs text-gray-500 italic ">{presentation.date}</span>
                        </div>
