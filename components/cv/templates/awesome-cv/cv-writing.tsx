                ...
                {props.writings.map((writing, index) => (
                    <div className="w-full" key={index}>
                        <div className="flex justify-between w-full">
                            ...
                            <span className="text-xs italic text-[#0395de]">{writing.medium}</span>
                        </div>
                        <div className="flex justify-between w-full">
                            <span className="text-xs text-gray-600">{writing.role.toUpperCase()}</span>
                            <span className="text-xs text-gray-500 italic ">{writing.startDate}{' - '}{writing.endDate}</span>
                        </div>
